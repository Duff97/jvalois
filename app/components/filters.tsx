...
const Filters = () => {
  ...
  return (
    <div className='flex justify-evenly overflow-hidden rounded-2xl w-max font-semibold lg:text-xl shadow-md text-base mb-5 md:mb-0 cursor-pointer '>
      <div 
        onClick={() => handleFilterEvent('painting')} 
        className='hover:opacity-75 p-3 xl:p-5'
      ...
      <div 
        ...
        className='hover:opacity-75 p-3 xl:p-5 border-r border-sky-200 border-dashed border-l'
